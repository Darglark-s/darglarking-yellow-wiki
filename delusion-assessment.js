  ...
  var PROFILES = {
    ...
    beta: {
      ...
      unlocks: [
        ...
        { href: "case-studies.html#case-01", label: "Case File 01 · Researcher Vance · Burned-Out Veteran trope" },
        { href: "magic.html#tier-two", label: "Magic · Tier 2 Frontier Wardens" },
      ],
    ...
    gamma: {
      ...
      unlocks: [
        ...
        { href: "magic.html#tier-three", label: "Magic · Tier 3 Archivists · generational relay" },
      ],
